...
function SectionTitle({ number, children }: { number: string; children: React.ReactNode }) {
  return (
    <div className="flex justify-between items-baseline mb-8">
      ...
      <span className="font-mono text-[12px] text-[#6a6058] font-[300] leading-[1.8]">
        {number}
      </span>
    </div>
  );
...
function Footer() {
  return (
    <footer className="mx-auto max-w-[720px] px-8 pt-[4rem] pb-12">
      ...
      <div className="text-center font-serif-zh font-[300] text-[13px] text-[#7a6840] tracking-[0.2em] mt-6 leading-[1.8]">
        饶乐祺 · 自强不息
      </div>
    </footer>
  );
